...
$(function() {
  ...
  // Radius Box
  $('.menu_nav ul li a, .content .mainbar img.fl, .content .mainbar .post_content a.rm, .content p.pages span, .content p.pages a').css({"border-radius":"6px", "-moz-border-radius":"6px", "-webkit-border-radius":"6px"});
