...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="sidebar">
        <div class="gadget">
          <h2 class="star">HR  Menu</h2>
          <div class="clr"></div>
          <ul class="sb_menu">
           <li><a href="hrviewnote.jsp">View Notifications </a></li>
            <li><a href="hrempdetails1.jsp">View Employee Details</a></li>
            <li><a href="hrempfill1.jsp">Add Employee Details </a></li>
...
try
{
	...
	PreparedStatement ps=con.prepareStatement("insert into infotohr values(?,?,?,?,?)");
	ps.setInt(1,emid);
...
%>
<form>
<h2>Information has been successfully inserted with Emp. Id:<%out.println(emid); %></h2>
