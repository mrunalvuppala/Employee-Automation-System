...
String empfield=request.getParameter("select");
String nvalue=request.getParameter("t2");
Connection con=null;
int n;
String s1,s2;
try
{
	...
	PreparedStatement ps=con.prepareStatement("update termination set '"+empfield+"'='"+nvalue+"' where empid='"+emid+"'");
